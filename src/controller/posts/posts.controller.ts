...
import { createPostSchema, postIdSchema, updatePostParamsSchema, updatePostSchema } from "../../validation/posts.validation";
import { db } from "../../config/db";
import { categoriesTable, postsTable  } from "../../config/schema";
import { and, eq, desc } from "drizzle-orm";
import { deleteFromCloudinary, uploadToCloudinary } from "../../servies/cloudinary.service";
